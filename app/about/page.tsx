    ...
    <div className="min-h-screen w-full flex flex-col" style={{ background: "var(--background)" }}>
      ...
      <main className="flex-1 px-6 py-8 max-w-[1400px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-xl border p-6" style={{ background: "var(--surface-2)", borderColor: "#BFFF0033" }}>
          ...
          <div className="rounded-xl border p-6" style={{ background: "var(--surface-2)", borderColor: "#00E5FF33" }}>
          ...
          <div className="rounded-xl border p-6" style={{ background: "var(--surface-2)", borderColor: "#FF3B3B33" }}>
